...
- The _**Buenrostro2018 using bulk peaks**_ dataset (folder name **'Buenrostro_2018_bulkpeaks'**)
  ...
  - [clustering](https://nbviewer.jupyter.org/github/pinellolab/scATAC-benchmarking/blob/master/Real_Data/Buenrostro_2018_bulkpeaks/run_clustering_buenrostro2018bulkpeaks.ipynb?flush_cache=true)
